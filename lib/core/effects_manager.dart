...
class EffectsManager {
  ...
  static Widget getFireworksEffect() {
    final colors = [
      Colors.red,
      Colors.orange,
      Colors.yellow,
    ...
    return Stack(
      children: List.generate(12, (index) {
        ...
        return Positioned(
          left: MediaQuery.of(WidgetsBinding.instance.context!).size.width * startX,
          top: MediaQuery.of(WidgetsBinding.instance.context!).size.height * startY,
          child: Container(
            width: 8,
            height: 8,
        ...
        Positioned.fill(
          child: List.generate(5, (index) {
            ...
            return Positioned(
              ...
              child: const Text(
                '⭐',
                style: TextStyle(fontSize: 30 + index * 5),
              ).animate()
                .moveY(
                  begin: 0,
                  end: -100 - (index * 30),
